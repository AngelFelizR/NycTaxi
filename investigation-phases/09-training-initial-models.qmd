...
## Training exploring variable importance

```{r}
rm(list = grep("^WorkFlowTuned$|Recipe$", ls(), value = TRUE))
gc()
```
...
pin_write(
  BoardLocal,
  x = ExplainerXgboost,
  name = "ExplainerXgboost",
  type = "qs2",
  title = "Explainer Xgboost"
)
