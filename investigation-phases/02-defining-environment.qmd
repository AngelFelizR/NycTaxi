...
Navigate to the parent directory where you want to store the project. Then, clone the repository:
...
2.  **Using Positron**: Select the **"Connect to Host"** option in **Positron** and enter `root@localhost:2222` with `"r"` as the password.
