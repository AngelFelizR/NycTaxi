...
ValidTablesYearsFilePath = here("cache-data/08-expanding-transportation-socioeconomic/ValidTablesYears.fst")
...
ValidTablesLastYearFilePath <- here("cache-data/08-expanding-transportation-socioeconomic/ValidTablesLastYear.fst")
...
ConceptsToExploreByDistanceFilePath <-
  here("cache-data/08-expanding-transportation-socioeconomic/ConceptsToExploreByDistance.fst")
...
AcsVariableTractsFilePath <- here("cache-data/08-expanding-transportation-socioeconomic/AcsVariableTracts.qs")

if(file.exists(ValidTablesLastYearFilePath)) {
  AcsVariableTracts <- qs2::qs_read(AcsVariableTractsFilePath)
}

DecVariableTractsFilePath <- here("cache-data/08-expanding-transportation-socioeconomic/DecVariableTracts.qs")
...
ConsolidatedVariableTractsJoinedFilePath <- here("cache-data/08-expanding-transportation-socioeconomic/ConsolidatedVariableTractsJoined.qs")
...
ConsolidatedVariableTractsByZoneIdFilePath <- here("cache-data/08-expanding-transportation-socioeconomic/ConsolidatedVariableTractsByZoneId.fst")
...
PuVariableTractsMeanDiffFilePath <-
  here("cache-data/08-expanding-transportation-socioeconomic/PuVariableTractsMeanDiff.fst")

DoVariableTractsMeanDiffFilePath <-
  here("cache-data/08-expanding-transportation-socioeconomic/DoVariableTractsMeanDiff.fst")
...
fst::write_fst(
  ...
  path = here("raw-data/AcsVariablesByZoneId.fst")
)
```
