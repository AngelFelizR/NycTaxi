...
ggplot(Asc1WordDistanceDt)+
  stat_ecdf(aes(`Jaccard Distance`)) +
  scale_y_continuous(breaks = breaks_width(0.02),
...
```{r}
Asc1WordDistanceDt[`Jaccard Distance` <= 0.4, uniqueN(c(`Variable Name 1`, `Variable Name 2`))]
```
