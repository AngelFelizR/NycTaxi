...
if (!exists("ConceptsToExploreByDistance")) {
  ConceptsToExploreByDistance <- pin_read(BoardLocal, "ConceptsToExploreByDistance")
}
```
...
if (!exists("ConsolidatedVariableTractsJoined")) {
  ConsolidatedVariableTractsJoined <- pin_read(BoardLocal, "ConsolidatedVariableTractsJoined")
}
```
