...
ZoneCodesRef <- BoardRemote |> pin_read("ZoneCodesRef")
...
if(!exists("SimulationStartDay")){
  SimulationStartDay <- BoardRemote |> pin_read("SimulationStartDay")
...
if(!exists("SimulationHourlyWage")){
  SimulationHourlyWage <- BoardRemote |> pin_read("SimulationHourlyWage")
}
```
