...
# Saving results
fst::write_fst(SimulationStartDay, here("cache-data/04-base-line/SimulationStartDay.fst"))
...
SimulationStartDay <-
  here("cache-data/04-base-line/SimulationStartDay.fst") |>
...
fst::write_fst(PointMeanDistance,here("cache-data/04-base-line/PointMeanDistance.fst"))
```
...
if(exists("SimulationHourlyWage")){
  fst::write_fst(SimulationHourlyWage, here("cache-data/04-base-line/SimulationHourlyWage.fst"))
}else{
  SimulationHourlyWage <- fst::read_fst(
    here("cache-data/04-base-line/SimulationHourlyWage.fst"),
    as.data.table = TRUE
  )
}
```
