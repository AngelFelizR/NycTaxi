...
bb_boxFilePath <- here("cache-data/07-expanding-geospatial-data/bb_box.qs")
...
This section retrieves geospatial data from OpenStreetMap (OSM) for the features listed in `FeaturesToGet` and save it in RDS files in the `cache-data/07-expanding-geospatial-data/ directory` to **speed up the development process** of this portfolio.
...
for(feature_i in FeaturesToGet){
  ...
  saveRDS(OsmData, 
          here(sprintf("cache-data/07-expanding-geospatial-data/feature_%s.rds", feature_i)), 
          compress = "xz")
}
```
...
OsmDataComplete <-
  FeaturesToGet |>
  sapply(FUN = \(x) here(sprintf("cache-data/07-expanding-geospatial-data/feature_%s.rds", x))) |>
  lapply(FUN = readRDS) |>
  do.call(what = "c") |>
...
qs2::qs_save(OsmDataComplete, 
             here("cache-data/07-expanding-geospatial-data/OsmDataComplete.qs"))
```
...
OsmDataComplete <- qs2::qs_read(here("cache-data/07-expanding-geospatial-data/OsmDataComplete.qs"))
...
PointsWithinZones <-
  qs2::qs_read(here("cache-data/07-expanding-geospatial-data/PointsWithinZones.qs"))

LinesWithinZones <-
  qs2::qs_read(here("cache-data/07-expanding-geospatial-data/LinesWithinZones.qs"))

MultiLinesWithinZones <-
  qs2::qs_read(here("cache-data/07-expanding-geospatial-data/MultiLinesWithinZones.qs"))

PolygonWithinZones <-
  qs2::qs_read(here("cache-data/07-expanding-geospatial-data/PolygonWithinZones.qs"))

MultiPolygonWithinZones <-
  qs2::qs_read(here("cache-data/07-expanding-geospatial-data/MultiPolygonWithinZones.qs"))
```
...
qs2::qs_save(PointsWithinZones, 
             here("cache-data/07-expanding-geospatial-data/PointsWithinZones.qs"))

qs2::qs_save(LinesWithinZones, 
             here("cache-data/07-expanding-geospatial-data/LinesWithinZones.qs"))

qs2::qs_save(MultiLinesWithinZones, 
             here("cache-data/07-expanding-geospatial-data/MultiLinesWithinZones.qs"))

qs2::qs_save(PolygonWithinZones, 
             here("cache-data/07-expanding-geospatial-data/PolygonWithinZones.qs"))

qs2::qs_save(MultiPolygonWithinZones, 
             here("cache-data/07-expanding-geospatial-data/MultiPolygonWithinZones.qs"))
```
...
LinesInSeveralZones <-
  qs2::qs_read(here("cache-data/07-expanding-geospatial-data/LinesInSeveralZones.qs"))

MultiLinesInSeveralZones <-
  qs2::qs_read(here("cache-data/07-expanding-geospatial-data/MultiLinesInSeveralZones.qs"))

PolygonInSeveralZones <-
  qs2::qs_read(here("cache-data/07-expanding-geospatial-data/PolygonInSeveralZones.qs"))

MultiPolygonInSeveralZones <-
  qs2::qs_read(here("cache-data/07-expanding-geospatial-data/MultiPolygonInSeveralZones.qs"))
```
...
qs2::qs_save(LinesInSeveralZones, 
             here("cache-data/07-expanding-geospatial-data/LinesInSeveralZones.qs"))

qs2::qs_save(MultiLinesInSeveralZones, 
             here("cache-data/07-expanding-geospatial-data/MultiLinesInSeveralZones.qs"))
             
qs2::qs_save(PolygonInSeveralZones, 
             here("cache-data/07-expanding-geospatial-data/PolygonInSeveralZones.qs"))

qs2::qs_save(MultiPolygonInSeveralZones, 
             here("cache-data/07-expanding-geospatial-data/MultiPolygonInSeveralZones.qs"))
```
...
LinesInSeveralZonesCropped <-
  qs2::qs_read(here("cache-data/07-expanding-geospatial-data/LinesInSeveralZonesCropped.qs"))

MultiLinesInSeveralZonesCropped <-
  qs2::qs_read(here("cache-data/07-expanding-geospatial-data/MultiLinesInSeveralZonesCropped.qs"))

PolygonInSeveralZonesCropped <-
  qs2::qs_read(here("cache-data/07-expanding-geospatial-data/PolygonInSeveralZonesCropped.qs"))

MultiPolygonInSeveralZonesCropped <-
  qs2::qs_read(here("cache-data/07-expanding-geospatial-data/MultiPolygonInSeveralZonesCropped.qs"))
```
...
qs2::qs_save(LinesInSeveralZonesCropped, 
             here("cache-data/07-expanding-geospatial-data/LinesInSeveralZonesCropped.qs"))

qs2::qs_save(MultiLinesInSeveralZonesCropped, 
             here("cache-data/07-expanding-geospatial-data/MultiLinesInSeveralZonesCropped.qs"))

qs2::qs_save(PolygonInSeveralZonesCropped, 
             here("cache-data/07-expanding-geospatial-data/PolygonInSeveralZonesCropped.qs"))

qs2::qs_save(MultiPolygonInSeveralZonesCropped, 
             here("cache-data/07-expanding-geospatial-data/MultiPolygonInSeveralZonesCropped.qs"))
```
...
AllPointsZones <-
  qs2::qs_read(here("cache-data/07-expanding-geospatial-data/AllPointsZones.qs"))

AllLinesZones <-
  qs2::qs_read(here("cache-data/07-expanding-geospatial-data/AllLinesZones.qs"))

AllPolygonZones <-
  qs2::qs_read(here("cache-data/07-expanding-geospatial-data/AllPolygonZones.qs"))
```
...
qs2::qs_save(AllPointsZones, 
             here("cache-data/07-expanding-geospatial-data/AllPointsZones.qs"))

qs2::qs_save(AllLinesZones, 
             here("cache-data/07-expanding-geospatial-data/AllLinesZones.qs"))

qs2::qs_save(AllPolygonZones, 
             here("cache-data/07-expanding-geospatial-data/AllPolygonZones.qs"))
```
...
PointDensityFeatures <-
  qs2::qs_read(here("cache-data/07-expanding-geospatial-data/PointDensityFeatures.qs"))

LineDensityFeatures <-
  qs2::qs_read(here("cache-data/07-expanding-geospatial-data/LineDensityFeatures.qs"))

PolygonDensityFeatures <-
  qs2::qs_read(here("cache-data/07-expanding-geospatial-data/PolygonDensityFeatures.qs"))
```
...
qs2::qs_save(PointDensityFeatures, 
             here("cache-data/07-expanding-geospatial-data/PointDensityFeatures.qs"))

qs2::qs_save(LineDensityFeatures, 
             here("cache-data/07-expanding-geospatial-data/LineDensityFeatures.qs"))

qs2::qs_save(PolygonDensityFeatures, 
             here("cache-data/07-expanding-geospatial-data/PolygonDensityFeatures.qs"))
```
...
CorMatrix = qs2::qs_read(here("cache-data/07-expanding-geospatial-data/CorMatrix.qs"))
```
...
qs2::qs_save(CorMatrix, 
             here("cache-data/07-expanding-geospatial-data/CorMatrix.qs"))
```
...
TopOsmCorrelations = qs2::qs_read(here("cache-data/07-expanding-geospatial-data/TopOsmCorrelations.qs"))
```
...
qs2::qs_save(TopOsmCorrelations, 
             here("cache-data/07-expanding-geospatial-data/TopOsmCorrelations.qs"))
```
...
OsmMedianDiff = qs2::qs_read(here("cache-data/07-expanding-geospatial-data/OsmMedianDiff.qs"))
```
...
qs2::qs_save(OsmMedianDiff, 
             here("cache-data/07-expanding-geospatial-data/OsmMedianDiff.qs"))
```
...
TopOsmMedianDiff = qs2::qs_read(here("cache-data/07-expanding-geospatial-data/TopOsmMedianDiff.qs"))
...
qs2::qs_save(TopOsmMedianDiff, 
             here("cache-data/07-expanding-geospatial-data/TopOsmMedianDiff.qs"))
```
...
fst::write_fst(OmsDensityFeatures[, ..FeaturesToKeep], 
               path = here("raw-data/OmsDensityFeatures.fst"))
```
