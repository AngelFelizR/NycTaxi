...
#   at run-time.
{
  ...
  # These profiles contain R packages from r-core, r-data, r-geo, r-ml, r-custom
  nix_profiles <- c(
    "/nix/profiles/r-core/lib/R/library",
    "/nix/profiles/r-data/lib/R/library",
    "/nix/profiles/r-geo/lib/R/library",
    "/nix/profiles/r-ml/lib/R/library",
    "/nix/profiles/r-custom/lib/R/library"
  )
  # Prepend these paths to the library search path (they will be used first)
  .libPaths(c(nix_profiles, .libPaths()))
