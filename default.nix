# This file was generated by the {rix} R package v0.16.0 on 2025-10-26
# with following call:
# >rix(r_ver = "4.5.1",
#  > r_pkgs = c("data.table",
#  > "lubridate",
...
let
 pkgs = import (fetchTarball "https://github.com/rstats-on-nix/nixpkgs/archive/2025-10-20.tar.gz") {};
