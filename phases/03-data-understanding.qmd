...
1. Importing the data between points.
...
ValidZoneSampleByMonth <-
  ValidZoneSample[1:5][, request_datetime_extra := request_datetime + minutes(15)
...
FirstData <- dbGetQuery(con, "
SELECT * 
FROM 
  read_parquet('raw-data/trip-data/year=2022/month=01/part-0.parquet')
WHERE
  request_datetime >= '2022-01-01 03:05:09' 
  AND request_datetime < '2022-01-01 04:00:00' 
") |>
  as.data.table()
