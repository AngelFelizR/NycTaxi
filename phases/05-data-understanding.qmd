...
2. 50% of zones get 1k of less trips from the training sample and around 5% of zones get 3k or more trips based on the training set.
...
rbind(TrainingSampleZones[, .(Type = "Dropoffs",
  ...
  scale_x_continuous(breaks = breaks_width(1000),
                     labels = comma_format()) +
  scale_color_manual(values = c("Dropoffs" = ColorHighlight,
                                "Pickups" = "black")) +
  labs(title = "Cumulative Distribution Number of Trips",
       x = "Number of Trips",
       y = "Proportion of Unique Locations",
...
ggplot(TrainingSample) + 
  geom_boxplot(aes("1",trip_miles)) + 
  scale_y_log10(breaks = 10^(0:10/2),
                labels = comma_format())

TrainingSample[, names(.SD), .SDcols = is.numeric]
```
