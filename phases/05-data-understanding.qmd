...
https://wiki.openstreetmap.org/wiki/Map_features#Additional_attributes
...
# - bb: el bounding box de tu área de interés
# - df: tu data.frame con las columnas "lat" y "lon"

# Obtener las calles como un objeto sf
streets <- opq(bbox = bb) %>%
...
intersections <- st_intersects(points, streets)

# Ver los resultados
# Si un punto interseca con alguna calle, intersections[[i]] será un entero positivo
# Si no interseca, será un integer(0)
intersections
```
